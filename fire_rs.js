 ...
 var port = "1883";
 var datos = [
     { topic: "anaquel/rs/led", value: "" },
     { topic: "anaquel/rs/vent", value: "" },
     { topic: "anaquel/rs/warmlight", value: "" },
     { topic: "anaquel/rs/riego", value: "" },
     { topic: "anaquel/rs/temperature", value: "" },
     { topic: "anaquel/rs/humidity", value: "" },
     { topic: "anaquel/rs/co2", value: "" },
     { topic: "anaquel/rs/automatic", value: "" },
     { topic: "anaquel/rs/hora/led", value: "" },
     { topic: "anaquel/rs/hora/warmlight", value: "" }
 ];
 ...
 client.on("connect", function() { //this library automatically reconnects on errors
     try {
         ...
         client.publish("anaquel/rs/automatic", 'on');
     } catch (ex) {
         console.log(ex);
     }
 });
 ...
 function control_rs() {
     ...
     if (timer(timer_par.rs.led, moment().hours(), moment().minutes())) client.publish(datos[0].topic, 'off');
     else client.publish(datos[0].topic, 'on'); //console.log("led")

     if (timer(timer_par.rs.warm, moment().hours(), moment().minutes())) client.publish(datos[2].topic, 'off');
     else {
 ...
 function read() {
     ...
     if (datos[7].value == "on") control_rs();
